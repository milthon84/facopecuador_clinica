    ...
    <div className="max-w-xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-ink-500">Registra una cuenta bancaria o caja de efectivo.</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-lilac-100 rounded-2xl shadow-sm p-6">
        <form action={createAccount} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-ink-400">Saldo con el que inicia esta cuenta en el sistema.</p>
          </div>
