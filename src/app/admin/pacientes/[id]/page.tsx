...
export default async function PacienteDetalle({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-10">
      <Link href="/admin/pacientes" className="inline-flex items-center gap-1 text-sm text-ink-600 hover:text-ink-900 mb-4 transition-colors">
        ...
        <div className="space-y-6 md:col-span-1">
          ...
          <div className="card p-6 bg-white border border-lilac-100 shadow-sm">
            <div className="flex flex-col gap-3 mb-4">
              ...
              <Link
                href={`/admin/pacientes/${patient.id}/editar-ficha`}
            ...
            <div className="bg-gold-50 border border-gold-200 rounded-3xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-gold-900 mt-1 max-w-md">
                  ...
                  Puedes registrar su atención y odontograma directamente.
                </p>
              </div>
              <Link
                href={`/admin/citas/${activeAppt.id}/atencion`}
                  ...
                  return (
                    <div key={a.id} className="p-5 hover:bg-lilac-50/10 transition-colors">
                      <div className="flex justify-between items-start gap-4">
                        <div>
                          <Link href={`/admin/citas/${a.id}`} className="text-sm hover:text-lilac-700 font-bold text-ink-900 transition-colors">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          {a.status === "attended" && (
                            <Link
                              href={`/admin/citas/${a.id}/atencion`}
